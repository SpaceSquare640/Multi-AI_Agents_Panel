...
- Chore: update CHANGELOG.md for v0.11.1-alpha [skip ci]
- Wire estimated cost into live dispatch and the Usage dashboard
- Chore: bump version to 0.12.0-alpha

## [0.11.1-alpha] - 2026-08-23

### Changes

- Chore: update CHANGELOG.md for v0.11.0-alpha [skip ci]
- Stage cost-estimation building blocks for Usage dashboard (not yet wired)
- Chore: bump version to 0.11.1-alpha
...
- Add npm-style default-deny permission sandbox for Skills (Beta queue 3/8)

### Changes

- Chore: update CHANGELOG.md for v0.6.0-alpha [skip ci]
